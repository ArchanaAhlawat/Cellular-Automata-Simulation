...
//		return currentParameterValues;
		return currentGameParameters.getGameLevelParameterMap();
	}
	
	protected Map<String, String> getCurrentGameStateParameters() {
...
//		this.setNextCellParameters(this.defaultValuesHelper.getDefaultMap(state));
	...
	/***
	 * @author Sam Slack (sls97)
	 * @param state The new state of the cell that the user is modifying
	 * 
	 * Allows user to change the state of a cell to any other possible cell type
	 */
